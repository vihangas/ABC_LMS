        ...
        <div class="w3-col m7">
                                    ...
                                    <div class="w3-container">
                                        ...
                                        <div class="w3-responsive w3-card-4">
                                            <table class="w3-table w3-striped w3-bordered">
                                                ...
                                                <tbody>
                                                <?php
                                                $select_stmt=$db->prepare("SELECT * FROM subject");	//sql select query
                                                $select_stmt->execute();
                                                while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="subject-edit.php?update_id=<?php echo $row['cid']; ?>" class="btn btn-warning">Edit</a></td>
            ...
            <div class="w3-row-padding">
                <div class="w3-col m12">
                    <div class="w3-card w3-round w3-white">
                        <div class="w3-container w3-padding">
                            <h2 class="w3-center">Add New Subjects</h2><br>
                            <p class="w3-center"><i class="fa fa-plus-circle w3-margin-bottom w3-text-theme" style="font-size:120px"></i></p><br>
                            <p class="w3-center"><button class="w3-btn w3-xlarge w3-theme-dark w3-hover-teal" onclick="window.location.href = 'subject-add.php'" style="font-weight:900;">Add New Subjects</button></p>
                        </div>
                    </div>
                </div>
            </div><br><br>
