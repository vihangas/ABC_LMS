...
if(isset($_REQUEST['update_id']))
{
    try
    {
        $id = $_REQUEST['update_id']; //get "update_id" from course-index.php page through anchor tag operation and store in "$id" variable
...
if(isset($_REQUEST['btn_update']))
{
    try
    {
        ...
        if(!isset($errorMsg))
        {
            $update_stmt=$db->prepare('UPDATE assignment SET asid=:name_up WHERE aid=:id'); //sql update query
            ...
            if($update_stmt->execute())
            {
                ...
                header("refresh:3;adminFile.php");	//refresh 3 second and redirect to course-index.php page
            }
        }
    }
    catch(PDOException $e)
    ...
    <div class="w3-col s12 w3-center">
        ...
        <form method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    Assignment ID :<input type="text" name="txt_name" class="form-control" value="" required/>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 m-t-15">
                    ...
                    <a href="adminfile.php" class="btn btn-danger">Cancel</a>
                </div>
            </div>
