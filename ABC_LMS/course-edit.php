...
if(isset($_REQUEST['btn_update']))
{
    try
    {
        ...
        if(!isset($errorMsg))
        {
            $update_stmt=$db->prepare('UPDATE course SET cname=:name_up WHERE cid=:id'); //sql update query
    ...
    <div class="w3-col s12 w3-center">
        ...
        <form method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    Course Name:<input type="text" name="txt_name" class="form-control" value="<?php echo $name; ?>" required/>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 m-t-15">
                    ...
                    <a href="course-index.php" class="btn btn-danger">Cancel</a>
                </div>
            </div>
